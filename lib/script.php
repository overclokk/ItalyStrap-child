...
function italystrap_add_style_and_script(){
	 ...
	 */
	wp_enqueue_style( 'bootstrap',  $pathchild . '/css/bootstrap.min.css', null, null, null);
...
function italystrap_jquery_local_fallback($src, $handle = null){
	...
	if ($add_jquery_fallback) {
		echo '<script>window.jQuery || document.write(\'<script src="' . $pathchild . '/js/jquery.min.js"><\/script>\')</script>' . "\n";
...
function italystrap_add_editor_styles() {
	...
	$arg = array(
		...
		$pathchild . '/css/bootstrap.min.css',
		$pathchild . '/css/admin.css'
		);
