...
add_action( 'add_meta_boxes_prodotti', 'slide_init' );
function slide_init(){
	add_meta_box(
		"slide",
		__('Select if you want show this in home page slider', 'ItalyStrap'),
		"italystrap_select_slide",
		"prodotti",
		"side",
		"high");
}
...
add_action( 'save_post', 'italystrap_meta_box_save', 10, 2 );
function italystrap_meta_box_save( $post_id, $post ){

	if ( 'prodotti' !== $post->post_type )
		return;
