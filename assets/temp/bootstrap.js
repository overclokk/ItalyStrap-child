...
!function (global, factory) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = factory() : "function" == typeof define && define.amd ? define(factory) : (global = global || self, global.Data = factory());
}(void 0, function () {
  "use strict";
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = factory() : "function" == typeof define && define.amd ? define(factory) : (global = global || self, global.Manipulator = factory());
}(void 0, function () {
  "use strict";
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? factory(exports) : "function" == typeof define && define.amd ? define(["exports"], factory) : (global = global || self, factory(global.Polyfill = {}));
  ...
  }), exports.defaultPreventedPreservedOnDispatch = defaultPreventedPreservedOnDispatch, Object.defineProperty(exports, "__esModule", {
    value: !0
  });
}), function (global, factory) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = factory(require("./polyfill.js")) : "function" == typeof define && define.amd ? define(["./polyfill.js"], factory) : (global = global || self, global.SelectorEngine = factory(global.Polyfill));
}(void 0, function (polyfill_js) {
  "use strict";
  ...
  var NODE_TEXT = 3,
    ...
    children: function children(element, selector) {
      var _ref2,
          children = (_ref2 = []).concat.apply(_ref2, element.children);
    ...
    parents: function parents(element, selector) {
      for (var parents = [], ancestor = element.parentNode; ancestor && ancestor.nodeType === Node.ELEMENT_NODE && ancestor.nodeType !== NODE_TEXT;) {
        this.matches(ancestor, selector) && parents.push(ancestor), ancestor = ancestor.parentNode;
      }
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = factory(require("./dom/data.js"), require("./dom/event-handler.js")) : "function" == typeof define && define.amd ? define(["./dom/data.js", "./dom/event-handler.js"], factory) : (global = global || self, global.Alert = factory(global.Data, global.EventHandler));
  ...
  Data = Data && Object.prototype.hasOwnProperty.call(Data, "default") ? Data["default"] : Data, EventHandler = EventHandler && Object.prototype.hasOwnProperty.call(EventHandler, "default") ? EventHandler["default"] : EventHandler;
  ...
  var MILLISECONDS_MULTIPLIER = 1e3,
    ...
    return floatTransitionDuration || floatTransitionDelay ? (transitionDuration = transitionDuration.split(",")[0], transitionDelay = transitionDelay.split(",")[0], (parseFloat(transitionDuration) + parseFloat(transitionDelay)) * MILLISECONDS_MULTIPLIER) : 0;
  },
    ...
    var called = !1,
        durationPadding = 5,
        emulatedDuration = duration + durationPadding;
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
    ...
    var button = event.target.closest(SELECTOR_DATA_TOGGLE),
        data = Data.getData(button, DATA_KEY);
...
}(void 0, function (Data, EventHandler, Manipulator, SelectorEngine) {
  "use strict";
  ...
  var MILLISECONDS_MULTIPLIER = 1e3,
    ...
    function Carousel(element, config) {
      this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(config), this._element = element, this._indicatorsElement = SelectorEngine.findOne(SELECTOR_INDICATORS, this._element), this._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent), this._addEventListeners(), Data.setData(element, DATA_KEY, this);
    }
    ...
    return _proto.next = function () {
      ...
      event || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config && this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval));
      ...
      EventHandler.off(this._element, EVENT_KEY), Data.removeData(this._element, DATA_KEY), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null;
    }, _proto._getConfig = function (config) {
      return config = _objectSpread(_objectSpread({}, Default), config), typeCheckConfig(NAME, config, DefaultType), config;
      ...
      var _this3 = this,
        ...
        _this3._pointerEvent && PointerType[event.pointerType.toUpperCase()] && (_this3.touchDeltaX = event.clientX - _this3.touchStartX), _this3._handleSwipe(), "hover" === _this3._config.pause && (_this3.pause(), _this3.touchTimeout && clearTimeout(_this3.touchTimeout), _this3.touchTimeout = setTimeout(function (event) {
      ...
      if (this._indicatorsElement) {
        for (var indicators = SelectorEngine.find(SELECTOR_ACTIVE, this._indicatorsElement), i = 0; i < indicators.length; i++) {
      ...
      if (direction === DIRECTION_NEXT ? (directionalClassName = CLASS_NAME_LEFT, orderClassName = CLASS_NAME_NEXT, eventDirectionName = DIRECTION_LEFT) : (directionalClassName = CLASS_NAME_RIGHT, orderClassName = CLASS_NAME_PREV, eventDirectionName = DIRECTION_RIGHT), nextElement && nextElement.classList.contains(CLASS_NAME_ACTIVE)) return void (this._isSliding = !1);

      var slideEvent = this._triggerSlideEvent(nextElement, eventDirectionName);

      if (!slideEvent.defaultPrevented && activeElement && nextElement) {
        if (this._isSliding = !0, isCycling && this.pause(), this._setActiveIndicatorElement(nextElement), this._element.classList.contains(CLASS_NAME_SLIDE)) {
          ...
          EventHandler.one(activeElement, TRANSITION_END, function () {
            nextElement.classList.remove(directionalClassName, orderClassName), nextElement.classList.add(CLASS_NAME_ACTIVE), activeElement.classList.remove(CLASS_NAME_ACTIVE, orderClassName, directionalClassName), _this4._isSliding = !1, setTimeout(function () {
        ...
        } else activeElement.classList.remove(CLASS_NAME_ACTIVE), nextElement.classList.add(CLASS_NAME_ACTIVE), this._isSliding = !1, EventHandler.trigger(this._element, EVENT_SLID, {
          relatedTarget: nextElement,
          direction: eventDirectionName,
          from: activeElementIndex,
          to: nextElementIndex
      ...
      var data = Data.getData(element, DATA_KEY),
          _config = _objectSpread(_objectSpread({}, Default), Manipulator.getDataAttributes(element));
      ...
      if (target && target.classList.contains(CLASS_NAME_CAROUSEL)) {
        ...
        slideIndex && (config.interval = !1), Carousel.carouselInterface(target, config), slideIndex && Data.getData(target, DATA_KEY).to(slideIndex), event.preventDefault();
      }
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_SLIDE, Carousel.dataApiClickHandler), EventHandler.on(window, EVENT_LOAD_DATA_API, function () {
    for (var carousels = SelectorEngine.find(SELECTOR_DATA_RIDE), i = 0, len = carousels.length; i < len; i++) {
  ...
  var MILLISECONDS_MULTIPLIER = 1e3,
    ...
    function Collapse(element, config) {
      this._isTransitioning = !1, this._element = element, this._config = this._getConfig(config), this._triggerArray = SelectorEngine.find(SELECTOR_DATA_TOGGLE + '[href="#' + element.id + '"],' + (SELECTOR_DATA_TOGGLE + '[data-target="#' + element.id + '"]'));
      ...
      this._parent = this._config.parent ? this._getParent() : null, this._config.parent || this._addAriaAndCollapsedClass(this._element, this._triggerArray), this._config.toggle && this.toggle(), Data.setData(element, DATA_KEY, this);
    }
    ...
    return _proto.toggle = function () {
      ...
      if (!this._isTransitioning && !this._element.classList.contains(CLASS_NAME_SHOW)) {
        ...
        if (actives) {
          ...
          if (activesData = tempActiveData[0] ? Data.getData(tempActiveData[0], DATA_KEY) : null, activesData && activesData._isTransitioning) return;
        }
        ...
        if (!startEvent.defaultPrevented) {
          ...
          this._element.classList.remove(CLASS_NAME_COLLAPSE), this._element.classList.add(CLASS_NAME_COLLAPSING), this._element.style[dimension] = 0, this._triggerArray.length && this._triggerArray.forEach(function (element) {
            element.classList.remove(CLASS_NAME_COLLAPSED), element.setAttribute("aria-expanded", !0);
          }), this.setTransitioning(!0);

          var complete = function complete() {
            _this._element.classList.remove(CLASS_NAME_COLLAPSING), _this._element.classList.add(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW), _this._element.style[dimension] = "", _this.setTransitioning(!1), EventHandler.trigger(_this._element, EVENT_SHOWN);
          },
          ...
          EventHandler.one(this._element, TRANSITION_END, complete), emulateTransitionEnd(this._element, transitionDuration), this._element.style[dimension] = this._element[scrollSize] + "px";
        }
      }
      ...
      if (!this._isTransitioning && this._element.classList.contains(CLASS_NAME_SHOW)) {
        ...
        if (!startEvent.defaultPrevented) {
          ...
          this._element.style[dimension] = this._element.getBoundingClientRect()[dimension] + "px", reflow(this._element), this._element.classList.add(CLASS_NAME_COLLAPSING), this._element.classList.remove(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW);
          ...
          var complete = function complete() {
            _this2.setTransitioning(!1), _this2._element.classList.remove(CLASS_NAME_COLLAPSING), _this2._element.classList.add(CLASS_NAME_COLLAPSE), EventHandler.trigger(_this2._element, EVENT_HIDDEN);
          };
      ...
      Data.removeData(this._element, DATA_KEY), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null;
    }, _proto._getConfig = function (config) {
      return config = _objectSpread(_objectSpread({}, Default), config), config.toggle = Boolean(config.toggle), typeCheckConfig(NAME, config, DefaultType), config;
      ...
      var data = Data.getData(element, DATA_KEY),
          _config = _objectSpread(_objectSpread(_objectSpread({}, Default), Manipulator.getDataAttributes(element)), "object" == _typeof(config) && config ? config : {});
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
    ...
    var triggerData = Manipulator.getDataAttributes(this),
        ...
        selectorElements = SelectorEngine.find(selector);
    selectorElements.forEach(function (element) {
      var config,
          data = Data.getData(element, DATA_KEY);
  ...
  Data = Data && Object.prototype.hasOwnProperty.call(Data, "default") ? Data["default"] : Data, EventHandler = EventHandler && Object.prototype.hasOwnProperty.call(EventHandler, "default") ? EventHandler["default"] : EventHandler, Manipulator = Manipulator && Object.prototype.hasOwnProperty.call(Manipulator, "default") ? Manipulator["default"] : Manipulator, Popper = Popper && Object.prototype.hasOwnProperty.call(Popper, "default") ? Popper["default"] : Popper, SelectorEngine = SelectorEngine && Object.prototype.hasOwnProperty.call(SelectorEngine, "default") ? SelectorEngine["default"] : SelectorEngine;
  ...
  var toType = function toType(obj) {
    ...
    function Dropdown(element, config) {
      this._element = element, this._popper = null, this._config = this._getConfig(config), this._menu = this._getMenuElement(), this._inNavbar = this._detectNavbar(), this._addEventListeners(), Data.setData(element, DATA_KEY, this);
    }
    ...
    return _proto.toggle = function () {
      ...
      if (!(this._element.disabled || this._element.classList.contains(CLASS_NAME_DISABLED) || this._menu.classList.contains(CLASS_NAME_SHOW))) {
        ...
        if (!showEvent.defaultPrevented) {
          if (!this._inNavbar) {
            ...
            "parent" === this._config.reference ? referenceElement = parent : isElement(this._config.reference) && (referenceElement = this._config.reference, "undefined" != typeof this._config.reference.jquery && (referenceElement = this._config.reference[0])), "scrollParent" !== this._config.boundary && parent.classList.add(CLASS_NAME_POSITION_STATIC), this._popper = new Popper(referenceElement, this._menu, this._getPopperConfig());
          }
          ...
          this._element.focus(), this._element.setAttribute("aria-expanded", !0), Manipulator.toggleClass(this._menu, CLASS_NAME_SHOW), Manipulator.toggleClass(this._element, CLASS_NAME_SHOW), EventHandler.trigger(parent, EVENT_SHOWN, relatedTarget);
        }
      }
    }, _proto.hide = function () {
      if (!this._element.disabled && !this._element.classList.contains(CLASS_NAME_DISABLED) && this._menu.classList.contains(CLASS_NAME_SHOW)) {
        ...
        hideEvent.defaultPrevented || (this._popper && this._popper.destroy(), Manipulator.toggleClass(this._menu, CLASS_NAME_SHOW), Manipulator.toggleClass(this._element, CLASS_NAME_SHOW), EventHandler.trigger(parent, EVENT_HIDDEN, relatedTarget));
      }
    }, _proto.dispose = function () {
      Data.removeData(this._element, DATA_KEY), EventHandler.off(this._element, EVENT_KEY), this._element = null, this._menu = null, this._popper && (this._popper.destroy(), this._popper = null);
      ...
      return config = _objectSpread(_objectSpread(_objectSpread({}, this.constructor.Default), Manipulator.getDataAttributes(this._element)), config), typeCheckConfig(NAME, config, this.constructor.DefaultType), config;
    }, _proto._getMenuElement = function () {
      return SelectorEngine.next(this._element, SELECTOR_MENU)[0];
    }, _proto._getPlacement = function () {
      var parentDropdown = this._element.parentNode,
          placement = PLACEMENT_BOTTOM;
      return parentDropdown.classList.contains(CLASS_NAME_DROPUP) ? (placement = PLACEMENT_TOP, this._menu.classList.contains(CLASS_NAME_MENURIGHT) && (placement = PLACEMENT_TOPEND)) : parentDropdown.classList.contains(CLASS_NAME_DROPRIGHT) ? placement = PLACEMENT_RIGHT : parentDropdown.classList.contains(CLASS_NAME_DROPLEFT) ? placement = PLACEMENT_LEFT : this._menu.classList.contains(CLASS_NAME_MENURIGHT) && (placement = PLACEMENT_BOTTOMEND), placement;
      ...
      return "function" == typeof this._config.offset ? offset.fn = function (data) {
        return data.offsets = _objectSpread(_objectSpread({}, data.offsets), _this2._config.offset(data.offsets, _this2._element) || {}), data;
      ...
      var data = Data.getData(element, DATA_KEY),
          _config = "object" == _typeof(config) ? config : null;
      ...
      if (!event || event.button !== RIGHT_MOUSE_BUTTON && ("keyup" !== event.type || event.key === TAB_KEY)) for (var toggles = SelectorEngine.find(SELECTOR_DATA_TOGGLE), i = 0, len = toggles.length; i < len; i++) {
        var parent = Dropdown.getParentFromElement(toggles[i]),
            context = Data.getData(toggles[i], DATA_KEY),
            relatedTarget = {
        ...
        if (event && "click" === event.type && (relatedTarget.clickEvent = event), context) {
          ...
          if (toggles[i].classList.contains(CLASS_NAME_SHOW) && !(event && ("click" === event.type && /input|textarea/i.test(event.target.tagName) || "keyup" === event.type && event.key === TAB_KEY) && dropdownMenu.contains(event.target))) {
            ...
            if (!hideEvent.defaultPrevented) {
              ...
              toggles[i].setAttribute("aria-expanded", "false"), context._popper && context._popper.destroy(), dropdownMenu.classList.remove(CLASS_NAME_SHOW), toggles[i].classList.remove(CLASS_NAME_SHOW), EventHandler.trigger(parent, EVENT_HIDDEN, relatedTarget);
            }
          }
        }
      }
      ...
      if ((/input|textarea/i.test(event.target.tagName) ? !(event.key === SPACE_KEY || event.key !== ESCAPE_KEY && (event.key !== ARROW_DOWN_KEY && event.key !== ARROW_UP_KEY || event.target.closest(SELECTOR_MENU))) : REGEXP_KEYDOWN.test(event.key)) && (event.preventDefault(), event.stopPropagation(), !this.disabled && !this.classList.contains(CLASS_NAME_DISABLED))) {
        var parent = Dropdown.getParentFromElement(this),
            isActive = this.classList.contains(CLASS_NAME_SHOW);
        ...
        if (items.length) {
          ...
          event.key === ARROW_UP_KEY && index > 0 && index--, event.key === ARROW_DOWN_KEY && index < items.length - 1 && index++, index = index === -1 ? 0 : index, items[index].focus();
        }
      }
  ...
  EventHandler.on(document, EVENT_KEYDOWN_DATA_API, SELECTOR_DATA_TOGGLE, Dropdown.dataApiKeydownHandler), EventHandler.on(document, EVENT_KEYDOWN_DATA_API, SELECTOR_MENU, Dropdown.dataApiKeydownHandler), EventHandler.on(document, EVENT_CLICK_DATA_API, Dropdown.clearMenus), EventHandler.on(document, EVENT_KEYUP_DATA_API, Dropdown.clearMenus), EventHandler.on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
  ...
  var MILLISECONDS_MULTIPLIER = 1e3,
    ...
    function Modal(element, config) {
      this._config = this._getConfig(config), this._element = element, this._dialog = SelectorEngine.findOne(SELECTOR_DIALOG, element), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0, Data.setData(element, DATA_KEY, this);
    }
    ...
    return _proto.toggle = function (relatedTarget) {
      ...
      if (!this._isShown && !this._isTransitioning) {
        ...
        this._isShown || showEvent.defaultPrevented || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), EventHandler.on(this._element, EVENT_CLICK_DISMISS, SELECTOR_DATA_DISMISS, function (event) {
      ...
      if (event && event.preventDefault(), this._isShown && !this._isTransitioning) {
        ...
        if (!hideEvent.defaultPrevented) {
          ...
          if (transition && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), EventHandler.off(document, EVENT_FOCUSIN), this._element.classList.remove(CLASS_NAME_SHOW), EventHandler.off(this._element, EVENT_CLICK_DISMISS), EventHandler.off(this._dialog, EVENT_MOUSEDOWN_DISMISS), transition) {
            var transitionDuration = getTransitionDurationFromElement(this._element);
      ...
      }), EventHandler.off(document, EVENT_FOCUSIN), Data.removeData(this._element, DATA_KEY), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null;
      ...
      var _this3 = this,
          transition = this._element.classList.contains(CLASS_NAME_FADE),
          modalBody = SelectorEngine.findOne(SELECTOR_MODAL_BODY, this._dialog);
      ...
      this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._showBackdrop(function () {
        document.body.classList.remove(CLASS_NAME_OPEN), _this7._resetAdjustments(), _this7._resetScrollbar(), EventHandler.trigger(_this7._element, EVENT_HIDDEN);
      });
    }, _proto._removeBackdrop = function () {
      this._backdrop.parentNode.removeChild(this._backdrop), this._backdrop = null;
    }, _proto._showBackdrop = function (callback) {
      var _this8 = this,
          animate = this._element.classList.contains(CLASS_NAME_FADE) ? CLASS_NAME_FADE : "";

      if (this._isShown && this._config.backdrop) {
        if (this._backdrop = document.createElement("div"), this._backdrop.className = CLASS_NAME_BACKDROP, animate && this._backdrop.classList.add(animate), document.body.appendChild(this._backdrop), EventHandler.on(this._element, EVENT_CLICK_DISMISS, function (event) {
        ...
        }), animate && reflow(this._backdrop), this._backdrop.classList.add(CLASS_NAME_SHOW), !animate) return void callback();
      ...
      SelectorEngine.find(SELECTOR_FIXED_CONTENT).forEach(function (element) {
        ...
        "undefined" != typeof padding && (Manipulator.removeDataAttribute(element, "padding-right"), element.style.paddingRight = padding);
      }), SelectorEngine.find("" + SELECTOR_STICKY_CONTENT).forEach(function (element) {
        var margin = Manipulator.getDataAttribute(element, "margin-right");
        "undefined" != typeof margin && (Manipulator.removeDataAttribute(element, "margin-right"), element.style.marginRight = margin);
      });
      var padding = Manipulator.getDataAttribute(document.body, "padding-right");
      "undefined" == typeof padding ? document.body.style.paddingRight = "" : (Manipulator.removeDataAttribute(document.body, "padding-right"), document.body.style.paddingRight = padding);
      ...
      return this.each(function () {
        var data = Data.getData(this, DATA_KEY),
            _config = _objectSpread(_objectSpread(_objectSpread({}, Default), Manipulator.getDataAttributes(this)), "object" == _typeof(config) && config ? config : {});
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = factory(require("./dom/data.js"), require("./dom/selector-engine.js"), require("./tooltip.js")) : "function" == typeof define && define.amd ? define(["./dom/data.js", "./dom/selector-engine.js", "./tooltip.js"], factory) : (global = global || self, global.Popover = factory(global.Data, global.SelectorEngine, global.Tooltip));
}(void 0, function (Data, SelectorEngine, Tooltip) {
  "use strict";
  ...
  Data = Data && Object.prototype.hasOwnProperty.call(Data, "default") ? Data["default"] : Data, SelectorEngine = SelectorEngine && Object.prototype.hasOwnProperty.call(SelectorEngine, "default") ? SelectorEngine["default"] : SelectorEngine, Tooltip = Tooltip && Object.prototype.hasOwnProperty.call(Tooltip, "default") ? Tooltip["default"] : Tooltip;
  ...
  var getjQuery = function getjQuery() {
    ...
    return jQuery && !document.body.hasAttribute("data-no-jquery") ? jQuery : null;
      ...
      Default = _objectSpread(_objectSpread({}, Tooltip.Default), {}, {
    placement: "right",
    trigger: "click",
    content: "",
    ...
    return _proto.isWithContent = function () {
      ...
      "function" == typeof content && (content = content.call(this.element)), this.setElementContent(SelectorEngine.findOne(SELECTOR_CONTENT, tip), content), tip.classList.remove(CLASS_NAME_FADE, CLASS_NAME_SHOW);
      ...
      return this.each(function () {
        ...
        if ((data || !/dispose|hide/.test(config)) && (data || (data = new Popover(this, _config), Data.setData(this, DATA_KEY, data)), "string" == typeof config)) {
          if ("undefined" == typeof data[config]) throw new TypeError('No method named "' + config + '"');
          data[config]();
        }
      });
  ...
  var MAX_UID = 1e6,
    ...
    function ScrollSpy(element, config) {
      ...
      this._element = element, this._scrollElement = "BODY" === element.tagName ? window : element, this._config = this._getConfig(config), this._selector = this._config.target + " " + SELECTOR_NAV_LINKS + "," + (this._config.target + " " + SELECTOR_LIST_ITEMS + ",") + (this._config.target + " ." + CLASS_NAME_DROPDOWN_ITEM), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, EventHandler.on(this._scrollElement, EVENT_SCROLL, function (event) {
    ...
    return _proto.refresh = function () {
      var _this2 = this,
          autoMethod = this._scrollElement === this._scrollElement.window ? METHOD_OFFSET : METHOD_POSITION,
          offsetMethod = "auto" === this._config.method ? autoMethod : this._config.method,
          offsetBase = offsetMethod === METHOD_POSITION ? this._getScrollTop() : 0;

      this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight();
      var targets = SelectorEngine.find(this._selector);
      targets.map(function (element) {
        var target,
            targetSelector = getSelectorFromElement(element);
      ...
      Data.removeData(this._element, DATA_KEY), EventHandler.off(this._scrollElement, EVENT_KEY), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null;
    }, _proto._getConfig = function (config) {
      if (config = _objectSpread(_objectSpread({}, Default), "object" == _typeof(config) && config ? config : {}), "string" != typeof config.target && isElement(config.target)) {
      ...
      link.classList.contains(CLASS_NAME_DROPDOWN_ITEM) ? (SelectorEngine.findOne(SELECTOR_DROPDOWN_TOGGLE, link.closest(SELECTOR_DROPDOWN)).classList.add(CLASS_NAME_ACTIVE), link.classList.add(CLASS_NAME_ACTIVE)) : (link.classList.add(CLASS_NAME_ACTIVE), SelectorEngine.parents(link, SELECTOR_NAV_LIST_GROUP).forEach(function (listGroup) {
      ...
      return this.each(function () {
        var data = Data.getData(this, DATA_KEY),
            _config = "object" == _typeof(config) && config;
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = factory(require("./dom/data.js"), require("./dom/event-handler.js"), require("./dom/selector-engine.js")) : "function" == typeof define && define.amd ? define(["./dom/data.js", "./dom/event-handler.js", "./dom/selector-engine.js"], factory) : (global = global || self, global.Tab = factory(global.Data, global.EventHandler, global.SelectorEngine));
}(void 0, function (Data, EventHandler, SelectorEngine) {
  "use strict";
    ...
    return _proto.show = function () {
      ...
      if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(CLASS_NAME_ACTIVE) || this._element.classList.contains(CLASS_NAME_DISABLED))) {
        var previous,
            ...
            listElement = this._element.closest(SELECTOR_NAV_LIST_GROUP);
      ...
      var _this2 = this,
          activeElements = !container || "UL" !== container.nodeName && "OL" !== container.nodeName ? SelectorEngine.children(container, SELECTOR_ACTIVE) : SelectorEngine.find(SELECTOR_ACTIVE_UL, container),
          active = activeElements[0],
          isTransitioning = callback && active && active.classList.contains(CLASS_NAME_FADE),
      ...
      if (active && isTransitioning) {
        ...
        active.classList.remove(CLASS_NAME_SHOW), EventHandler.one(active, TRANSITION_END, complete), emulateTransitionEnd(active, transitionDuration);
      } else complete();
      ...
      if (element.classList.add(CLASS_NAME_ACTIVE), "tab" === element.getAttribute("role") && element.setAttribute("aria-selected", !0), reflow(element), element.classList.contains(CLASS_NAME_FADE) && element.classList.add(CLASS_NAME_SHOW), element.parentNode && element.parentNode.classList.contains(CLASS_NAME_DROPDOWN_MENU)) {
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = factory(require("./dom/data.js"), require("./dom/event-handler.js"), require("./dom/manipulator.js")) : "function" == typeof define && define.amd ? define(["./dom/data.js", "./dom/event-handler.js", "./dom/manipulator.js"], factory) : (global = global || self, global.Toast = factory(global.Data, global.EventHandler, global.Manipulator));
}(void 0, function (Data, EventHandler, Manipulator) {
  "use strict";
  ...
  Data = Data && Object.prototype.hasOwnProperty.call(Data, "default") ? Data["default"] : Data, EventHandler = EventHandler && Object.prototype.hasOwnProperty.call(EventHandler, "default") ? EventHandler["default"] : EventHandler, Manipulator = Manipulator && Object.prototype.hasOwnProperty.call(Manipulator, "default") ? Manipulator["default"] : Manipulator;
  ...
  var MILLISECONDS_MULTIPLIER = 1e3,
    ...
    function Toast(element, config) {
      this._element = element, this._config = this._getConfig(config), this._timeout = null, this._setListeners(), Data.setData(element, DATA_KEY, this);
    }

    var _proto = Toast.prototype;
    return _proto.show = function () {
      var _this = this,
          showEvent = EventHandler.trigger(this._element, EVENT_SHOW);

      if (!showEvent.defaultPrevented) {
        this._config.animation && this._element.classList.add(CLASS_NAME_FADE);

        var complete = function complete() {
          _this._element.classList.remove(CLASS_NAME_SHOWING), _this._element.classList.add(CLASS_NAME_SHOW), EventHandler.trigger(_this._element, EVENT_SHOWN), _this._config.autohide && (_this._timeout = setTimeout(function () {
            _this.hide();
          }, _this._config.delay));
        };
      ...
      clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(CLASS_NAME_SHOW) && this._element.classList.remove(CLASS_NAME_SHOW), EventHandler.off(this._element, EVENT_CLICK_DISMISS), Data.removeData(this._element, DATA_KEY), this._element = null, this._config = null;
    }, _proto._getConfig = function (config) {
      return config = _objectSpread(_objectSpread(_objectSpread({}, Default), Manipulator.getDataAttributes(this._element)), "object" == _typeof(config) && config ? config : {}), typeCheckConfig(NAME, config, this.constructor.DefaultType), config;
  ...
  function sanitizeHtml(unsafeHtml, whiteList, sanitizeFn) {
    ...
    for (var domParser = new window.DOMParser(), createdDocument = domParser.parseFromString(unsafeHtml, "text/html"), whitelistKeys = Object.keys(whiteList), elements = (_ref = []).concat.apply(_ref, createdDocument.body.querySelectorAll("*")), _loop = function _loop(i, len) {
      var _ref2,
          el = elements[i],
          elName = el.nodeName.toLowerCase();

      if (whitelistKeys.indexOf(elName) === -1) return el.parentNode.removeChild(el), "continue";
  ...
  var MAX_UID = 1e6,
    ...
    return jQuery && !document.body.hasAttribute("data-no-jquery") ? jQuery : null;
      ...
      allowedAttribute = function allowedAttribute(attr, allowedAttributeList) {
    ...
    return _proto.enable = function () {
      ...
      if (this._isEnabled) if (event) {
        var dataKey = this.constructor.DATA_KEY,
            context = Data.getData(event.target, dataKey);
        context || (context = new this.constructor(event.target, this._getDelegateConfig()), Data.setData(event.target, dataKey, context)), context._activeTrigger.click = !context._activeTrigger.click, context._isWithActiveTrigger() ? context._enter(null, context) : context._leave(null, context);
      } else {
      ...
      if (this.isWithContent() && this._isEnabled) {
        var showEvent = EventHandler.trigger(this.element, this.constructor.Event.SHOW),
            shadowRoot = findShadowRoot(this.element),
            isInTheDom = null === shadowRoot ? this.element.ownerDocument.documentElement.contains(this.element) : shadowRoot.contains(this.element);
        if (showEvent.defaultPrevented || !isInTheDom) return;
        var tip = this.getTipElement(),
            tipId = getUID(this.constructor.NAME);
        tip.setAttribute("id", tipId), this.element.setAttribute("aria-describedby", tipId), this.setContent(), this.config.animation && tip.classList.add(CLASS_NAME_FADE);
        ...
        if (Data.setData(tip, this.constructor.DATA_KEY, this), this.element.ownerDocument.documentElement.contains(this.tip) || container.appendChild(tip), EventHandler.trigger(this.element, this.constructor.Event.INSERTED), this._popper = new Popper(this.element, tip, this._getPopperConfig(attachment)), tip.classList.add(CLASS_NAME_SHOW), "ontouchstart" in document.documentElement) {
          var _ref;
        ...
        var complete = function complete() {
          ...
          _this._hoverState = null, EventHandler.trigger(_this.element, _this.constructor.Event.SHOWN), prevHoverState === HOVER_STATE_OUT && _this._leave(null, _this);
        };
      ...
      var _this2 = this,
          ...
          complete = function complete() {
        _this2._hoverState !== HOVER_STATE_SHOW && tip.parentNode && tip.parentNode.removeChild(tip), _this2._cleanTipClass(), _this2.element.removeAttribute("aria-describedby"), EventHandler.trigger(_this2.element, _this2.constructor.Event.HIDDEN), _this2._popper.destroy();
      },
      ...
      if (!hideEvent.defaultPrevented) {
        ...
        if (this._activeTrigger[TRIGGER_CLICK] = !1, this._activeTrigger[TRIGGER_FOCUS] = !1, this._activeTrigger[TRIGGER_HOVER] = !1, this.tip.classList.contains(CLASS_NAME_FADE)) {
      ...
      var tip = this.getTipElement();
      this.setElementContent(SelectorEngine.findOne(SELECTOR_TOOLTIP_INNER, tip), this.getTitle()), tip.classList.remove(CLASS_NAME_FADE, CLASS_NAME_SHOW);
    }, _proto.setElementContent = function (element, content) {
      if (null !== element) return "object" == _typeof(content) && isElement(content) ? (content.jquery && (content = content[0]), void (this.config.html ? content.parentNode !== element && (element.innerHTML = "", element.appendChild(content)) : element.textContent = content.textContent)) : void (this.config.html ? (this.config.sanitize && (content = sanitizeHtml(content, this.config.whiteList, this.config.sanitizeFn)), element.innerHTML = content) : element.textContent = content);
      ...
      return "function" == typeof this.config.offset ? offset.fn = function (data) {
        return data.offsets = _objectSpread(_objectSpread({}, data.offsets), _this4.config.offset(data.offsets, _this4.element) || {}), data;
      ...
      }, EventHandler.on(this.element.closest("." + CLASS_NAME_MODAL), "hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = _objectSpread(_objectSpread({}, this.config), {}, {
        trigger: "manual",
        selector: ""
      }) : this._fixTitle();
      ...
      var dataKey = this.constructor.DATA_KEY;
      return context = context || Data.getData(event.target, dataKey), context || (context = new this.constructor(event.target, this._getDelegateConfig()), Data.setData(event.target, dataKey, context)), event && (context._activeTrigger["focusin" === event.type ? TRIGGER_FOCUS : TRIGGER_HOVER] = !0), context.getTipElement().classList.contains(CLASS_NAME_SHOW) || context._hoverState === HOVER_STATE_SHOW ? void (context._hoverState = HOVER_STATE_SHOW) : (clearTimeout(context._timeout), context._hoverState = HOVER_STATE_SHOW, context.config.delay && context.config.delay.show ? void (context._timeout = setTimeout(function () {
      ...
      var dataKey = this.constructor.DATA_KEY;
      if (context = context || Data.getData(event.target, dataKey), context || (context = new this.constructor(event.target, this._getDelegateConfig()), Data.setData(event.target, dataKey, context)), event && (context._activeTrigger["focusout" === event.type ? TRIGGER_FOCUS : TRIGGER_HOVER] = !1), !context._isWithActiveTrigger()) return clearTimeout(context._timeout), context._hoverState = HOVER_STATE_OUT, context.config.delay && context.config.delay.hide ? void (context._timeout = setTimeout(function () {
      ...
      }), config && "object" == _typeof(config.container) && config.container.jquery && (config.container = config.container[0]), config = _objectSpread(_objectSpread(_objectSpread({}, this.constructor.Default), dataAttributes), "object" == _typeof(config) && config ? config : {}), "number" == typeof config.delay && (config.delay = {
        show: config.delay,
        hide: config.delay
      }), "number" == typeof config.title && (config.title = config.title.toString()), "number" == typeof config.content && (config.content = config.content.toString()), typeCheckConfig(NAME, config, this.constructor.DefaultType), config.sanitize && (config.template = sanitizeHtml(config.template, config.whiteList, config.sanitizeFn)), config;
    }, _proto._getDelegateConfig = function () {
      var config = {};
      if (this.config) for (var key in this.config) {
      ...
      null === tip.getAttribute("x-placement") && (tip.classList.remove(CLASS_NAME_FADE), this.config.animation = !1, this.hide(), this.show(), this.config.animation = initConfigAnimation);
